    ...
    <div class="container">
      ...
      <div class="product-page-cake">
        ...
        <div class="right-cake">
          <div class="product1">
            <div class="img"><img src="birth1.jpeg" alt=""><br>Rs.500<br><a href="cartAction.php" action='addToCart' id='19' name='Vanilla Birthday Cake' class="btn">Add to Cart</a></div>
            <div class="img"><img src="birth2.jpeg" alt=""><br>Rs.900<br><a href="cartAction.php" action='addToCart' id='20' name='Chocolate Birthday Cake' class="btn">Add to Cart</a></div>
            <div class="img"><img src="birth3.jpeg" alt=""><br>Rs.2000<br><a href="cartAction.php" action='addToCart' id='21' name='Strawberry Birthday Cake' class="btn">Add to Cart</a></div>
          </div>
          <div class="product2">
            <div class="img"><img src="birth4.jpeg" alt=""><br>Rs.600<br><a href="cartAction.php" action='addToCart' id='22' name='Pineapple Birthday Cake' class="btn">Add to Cart</a></div>
            <div class="img"><img src="birth5.jpeg" alt=""><br>Rs.700<br><a href="cartAction.php" action='addToCart' id='23' name='Red Velvet Birthday Cake' class="btn">Add to Cart</a></div>
            <div class="img"><img src="birth6.jpeg" alt=""><br>Rs.900<br><a href="cartAction.php" action='addToCart' id='24' name='Floral Birthday Cake' class="btn">Add to Cart</a></div>
          </div>
        </div>
